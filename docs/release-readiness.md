...
| Latest full publication gate | ready | `scripts/release-candidate.sh` passed on `13c9cf8`, including clippy, the default gate, the full coverage matrix, and the public benchmark/coverage suite. |
