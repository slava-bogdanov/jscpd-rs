...
| Latest full publication gate | ready | `scripts/release-candidate.sh` passed on commit `da2dbf1`, including clippy, the default gate, the full coverage matrix, and the public benchmark/coverage suite. |
