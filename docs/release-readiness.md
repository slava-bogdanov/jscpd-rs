...
| Latest full publication gate | ready | `scripts/release-candidate.sh` passed on code commit `e55990b`, including clippy, the default gate, the full coverage matrix, and the public benchmark/coverage suite. |
