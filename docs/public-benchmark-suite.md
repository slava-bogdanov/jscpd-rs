...
| --- | --- | --- | ---: | ---: | ---: |
| `react` | `f0dfee3` | `javascript` | 0.189693s | 9.718442s | 51.23x |
| `next` | `2bbb67b9` | `typescript` | 0.237825s | 14.498516s | 60.96x |
| `prometheus` | `a0524ee` | `go` | 0.087638s | 4.518582s | 51.56x |
